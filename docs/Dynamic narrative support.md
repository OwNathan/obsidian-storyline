...
- The Scenarios view works like a kanban board, with a column for each existing phase. It must also show the Scenario Name and Description somewhere. Objectives can be added or created inside columns. Clicking on an Objective opens an inspector to edit its data. 
- The Objectives view works like a kanban board, with a column for each existing phase. It must also show the Objective Name and Description somewhere. Arcs can be added or created inside columns. Clicking on an Arc opens an inspector to edit its data.
- The Arcs view works like a kanban board, with a column for each existing phase. It must also show the Arc Name and Description somewhere. Arcs can be added or created inside columns. Clicking on a Quest opens an inspector to edit its data.
